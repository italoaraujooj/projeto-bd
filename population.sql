...
INSERT INTO ORDEM_DE_COMPRA (CODORDEM, DATA_COMPRA, STATUS, DESCONTO, VALOR_FRETE, END_RUA, END_NUM, END_BAIRRO, END_CIDADE, END_CEP, CODIGO_CLIENTE, CODIGO_TRANSPORTADORA)
VALUES (ORDEM_DE_COMPRA_NEXTVAL,TO_DATE('2023-06-06','YYYY-MM-DD'),'AGUARDANDO PAGAMENTO',5,12,'Rua ED 7','195','Setor Estrela Dalva','Goiânia','74475744',6,1);
INSERT INTO ORDEM_DE_COMPRA (CODORDEM, DATA_COMPRA, STATUS, DESCONTO, VALOR_FRETE, END_RUA, END_NUM, END_BAIRRO, END_CIDADE, END_CEP, CODIGO_CLIENTE, CODIGO_TRANSPORTADORA)
VALUES (ORDEM_DE_COMPRA_NEXTVAL,TO_DATE('2020-01-06','YYYY-MM-DD'),'FINALIZADA',15,15,'Rua Projetada 84','S/N','Conduru','Picos','64608370',7,2);
INSERT INTO ORDEM_DE_COMPRA (CODORDEM, DATA_COMPRA, STATUS, DESCONTO, VALOR_FRETE, END_RUA, END_NUM, END_BAIRRO, END_CIDADE, END_CEP, CODIGO_CLIENTE, CODIGO_TRANSPORTADORA)
VALUES (ORDEM_DE_COMPRA_NEXTVAL,TO_DATE('2020-01-06','YYYY-MM-DD'),'FINALIZADA',0,25,'Rua Joaquim Gomes Ferreira','203','Vargem Grande','Rio de Janeiro','22785660',8,4);
INSERT INTO ORDEM_DE_COMPRA (CODORDEM, DATA_COMPRA, STATUS, DESCONTO, VALOR_FRETE, END_RUA, END_NUM, END_BAIRRO, END_CIDADE, END_CEP, CODIGO_CLIENTE, CODIGO_TRANSPORTADORA)
VALUES (ORDEM_DE_COMPRA_NEXTVAL,TO_DATE('2023-04-06','YYYY-MM-DD'),'EM TRANSPORTE',11,20,'Rua Vereadora Maria Carolina da Costa Carmo','119','Jardim América','Itaguaí','23812750',9,1);
INSERT INTO ORDEM_DE_COMPRA (CODORDEM, DATA_COMPRA, STATUS, DESCONTO, VALOR_FRETE, END_RUA, END_NUM, END_BAIRRO, END_CIDADE, END_CEP, CODIGO_CLIENTE, CODIGO_TRANSPORTADORA)
VALUES (ORDEM_DE_COMPRA_NEXTVAL,TO_DATE('2023-02-06','YYYY-MM-DD'),'AGUARDANDO PAGAMENTO',10,30,'Travessa Zona Ampliada','124','Capoeira','Rio Branco','69905002',10,1);
...
VALUES (ORDEM_DE_COMPRA_SEQ, 1, 10, 1000);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 2, 10, 14898);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 3, 10, 403);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 4, 10, 93);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 5, 10, 60)
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 6, 10,70);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 7, 10, 99);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 1, 8, 800);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 2, 5, 7449);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 7, 10, 99);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 3, 1, 40.3);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 1, 12, 1200);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 3, 15, 604.5);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 4, 11,102.3);
INSERT INTO COMPRA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, QUANTIDADE, VALOR_ATUAL)
VALUES (ORDEM_DE_COMPRA_SEQ, 5, 1, 6);
...
INSERT INTO COMPRA_AVALIA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, NOTA, DESCRICAO)
VALUES (4, 3, 3, 'Embalagem danificada, produto OK');
INSERT INTO COMPRA_AVALIA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, NOTA, DESCRICAO)
VALUES (6, 3, 5, 'Produto conforme o esperado');
INSERT INTO COMPRA_AVALIA_PRODUTO(CODIGO_COMPRA, CODIGO_PRODUTO, NOTA, DESCRICAO)
VALUES (7, 1, 3, 'Atendimento ao cliente precisa melhorar');
